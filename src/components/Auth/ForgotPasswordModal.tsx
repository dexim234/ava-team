    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
            ...
            <div className={`relative w-full max-w-md overflow-hidden rounded-[2.5rem] ${bgColor} shadow-[0_32px_64px_-16px_rgba(0,0,0,0.3)] border ${borderColor} animate-in fade-in zoom-in duration-500`}>
                ...
                <div className="absolute -top-24 -left-24 w-64 h-64 bg-blue-500/20 rounded-full blur-[80px] pointer-events-none animate-pulse" />
                <div className="absolute top-1/2 -right-32 w-64 h-64 bg-indigo-500/10 rounded-full blur-[100px] pointer-events-none" />
                    ...
                    {!recoveredUser ? (
                        <div className="space-y-8">
                            <div className="text-center space-y-3">
                                <div className="relative inline-flex mb-2">
                                    ...
                                    <div className="relative p-4 rounded-2xl bg-gradient-to-br from-blue-500/10 to-cyan-500/5 text-blue-500 border border-blue-500/20">
                            ...
                            <form onSubmit={handleRecover} className="space-y-5">
                                <div className="space-y-2.5">
                                    ...
                                    <div className="relative group">
                                        <input
                                            ...
                                            className={`w-full px-5 py-4 rounded-2xl border transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-500/10 ${theme === 'dark'
                                ...
                                <button
                                    type="submit"
                                    className="w-full relative group overflow-hidden py-5 rounded-[1.25rem] bg-blue-500 text-white font-black transition-all duration-300 shadow-[0_20px_40px_-10px_rgba(59,130,246,0.3)] hover:shadow-[0_25px_50px_-12px_rgba(59,130,246,0.4)] hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
                                >
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-r from-blue-400 to-cyan-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                </button>
                            </form>
                        </div>
                    ) : (
                        <div className="space-y-6 text-center animate-in slide-in-from-bottom-8 duration-700">
                            <div className="relative inline-flex mb-2">
                                ...
                                <div className="relative p-5 rounded-3xl bg-blue-500 text-white shadow-xl shadow-blue-500/40">
                                ...
                                {[
                                    ...
                                    <div
                                        ...
                                        className={`group relative p-4 rounded-2xl border transition-all duration-300 cursor-pointer ${theme === 'dark'
                                            ...
                                            : 'bg-gray-50 border-gray-200 hover:border-blue-500/30 hover:bg-blue-50/30'
                                            }`}
                                    >
                                        <div className="flex items-center justify-between gap-4">
                                            <div className="flex items-center gap-3 min-w-0">
                                                <div className={`p-2 rounded-xl shrink-0 ${theme === 'dark' ? 'bg-white/5 text-blue-400' : 'bg-white text-blue-500 border border-blue-100'}`}>
                                            ...
                                            <div className={`p-2 rounded-lg transition-all duration-300 ${copiedField === field.id ? 'bg-blue-500 text-white' : 'bg-transparent text-gray-500 group-hover:text-blue-500'}`}>
