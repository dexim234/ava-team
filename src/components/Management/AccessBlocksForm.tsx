...
const FEATURE_GROUPS: FeatureGroup[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { value: 'tools_kontur_proptrading', label: 'Вкладка Prop-trading', description: 'Заблокировать вкладку в Контуре' },
  ...
  },
  {
    ...
    features: [
      ...
      { value: 'hub_signals_cat_memes_trading', label: 'Сигналы: Мемкоины (Торговля)', description: 'Запретить работу с мемкоинами в HUB' },
      { value: 'hub_signals_cat_memes_dev', label: 'Сигналы: Мемкоины (Dev)', description: 'Запретить работу с Мем-дев в HUB' },
  ...
  },
  {
    ...
    features: [
      ...
      { value: 'profit_cat_memes_trading', label: 'Категория: Мемкоины (Торговля)', description: 'Запретить доход по мемкоинам' },
      { value: 'profit_cat_memes_dev', label: 'Категория: Мемкоины (Dev)', description: 'Запретить доход по Мем-дев' },
      { value: 'profit_cat_prop_trading', label: 'Категория: Prop-trading', description: 'Запретить доход по Prop-trading' },
