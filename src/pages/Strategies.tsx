...
export type SlotCategory = 'memecoins' | 'futures' | 'nft' | 'spot' | 'airdrop' | 'polymarket' | 'staking' | 'other' | 'prop_trading'
...
export const SLOT_CATEGORY_META: Record<SlotCategory, { label: string; accent: string; icon: string }> = {
  ...
  prop_trading: { label: 'Проп-трейдинг', accent: 'purple', icon: 'briefcase' },
...
// Earnings types
export type EarningsCategory = 'memecoins' | 'futures' | 'nft' | 'spot' | 'airdrop' | 'polymarket' | 'staking' | 'other' | 'prop_trading'

export const EARNINGS_CATEGORY_META: Record<EarningsCategory, { label: string; accent: string; icon: 'rocket' | 'line' | 'image' | 'coins' | 'gift' | 'barchart' | 'shield' | 'sparkles' | 'briefcase'; gradient: string; shortName: string }> = {
  ...
  prop_trading: { label: 'Проп-трейдинг', accent: 'purple', icon: 'briefcase', gradient: 'from-purple-500 to-indigo-600', shortName: 'Проп' },
