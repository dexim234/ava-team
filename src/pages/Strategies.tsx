...
import { PropTradingStrategies } from '@/components/Strategies/PropTradingStrategies'

type TabType = 'memecoins' | 'polymarket' | 'nft' | 'staking' | 'spot' | 'futures' | 'airdrop' | 'other' | 'prop-trading'
...
export const Strategies = () => {
    ...
    const proptradingAccess = useAccessControl('tools_kontur_proptrading')
    ...
    const tabs: { id: TabType; label: string; icon: any; access: { hasAccess: boolean; loading: boolean } }[] = [
        ...
        { id: 'prop-trading', label: 'Проп-трейдинг', icon: <Briefcase className="w-4 h-4" />, access: proptradingAccess },
        ...
        <div className="space-y-6">
            ...
            <div className="animate-fade-in">
                {activeTab === 'memecoins' ? (
                    ...
                    <AirDropStrategies />
                ) : activeTab === 'prop-trading' ? (
                    <PropTradingStrategies />
                ) : activeTab === 'other' ? (
                    <OtherStrategies />
                ) : (
                    <div className="py-20 text-center space-y-4">
