...
const stageCards: StageCard[] = [
  ...
  },
  {
    ...
    description: 'Откройте раздел «Правила» на сайте (кнопка в шапке и в профиле), чтобы понимать ограничения по слотам, статусам и требованиям к рейтингу.',
...
faqData = [
  {
    question: 'Как начать работу с системой?',
    answer: '1) Войдите на сайт (роль: участник или админ). 2) Настройте тему — сохраняется. 3) Откройте HUB, Расписание, Заработок, Задачи, Рейтинг. 4) FAQ и страница «Правила» — в шапке.',
    category: 'auth',
  },
  {
      ...
      <div className="space-y-6">
        ...
        <div className={`${cardBg} rounded-lg shadow-lg p-6 border ${borderColor}`}>
          ...
          <p className={`${textColor} mb-4`}>
            Если вы не нашли ответ на свой вопрос, обратитесь к администратору или откройте страницу «Правила» в шапке сайта.
          </p>
