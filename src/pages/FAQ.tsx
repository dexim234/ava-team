...
faqData = [
  {
    question: 'Как начать работу с системой?',
    answer: '1) Войдите на сайт (роль: участник или админ). 2) Настройте тему — сохраняется. 3) Откройте HUB, Lead, Profit, Tasks, Score. 4) FAQ и страница «Правила» — кнопки на странице входа, в ЛК и в блоках «Ознакомиться с правилами».',
    category: 'auth',
  },
  {
  ...
  },
  {
    ...
    answer: 'HUB — сигналы и аналитика. Lead — слоты и статусы (таблица/неделя). Profit — доходы и пул. Tasks — канбан и согласование. Score — эффективность, рефералы, сообщения. FAQ и INFO — справка. AVA Profile — личные данные и метрики. Controls — только для админа.',
    category: 'interface',
  },
  {
  ...
  },
  {
    ...
    answer: 'Раздел “Lead”: виды таблица/неделя, фильтры по участникам и статусам. Добавление слотов, выходных, больничных, отпусков. Админ ставит массово на несколько дат и участников.',
    category: 'slots',
  },
  {
    question: 'Выходной, больничный, отпуск',
    answer: 'В “Lead” выберите тип: выходной (до 2/нед, не более 3 человек в день), больничный (обычные: сегодня+2, админ: любые даты, до 14 дней/мес), отпуск (до 14 дней/мес, до 6 раз/год).',
    category: 'status',
  },
  {
    question: 'Как добавить заработок и пул?',
    answer: '“Profit”: “Добавить заработок” — дата, сумма, пул, участники. Пул: “Добавить в пул” для завершенного слота. Обычные — только за сегодня, админ — за любую дату.',
    category: 'earnings',
  },
  {
    question: 'Как считается рейтинг?',
    answer: 'Score (до 100%) раз в неделю: выходные, больничные, отпуск, часы, заработок, рефералы, сообщения. Детализация и цветовые зоны — в “Score”.',
    category: 'rating',
  },
  {
    question: 'Рефералы',
    answer: 'В “Score” → “Добавить реферала”: имя, контакт, комментарий. Начисление: 5% за каждого, максимум 30% (6 шт.), учитываются 30 дней. Там же редактирование и удаление.',
    category: 'referrals',
  },
  {
    question: 'Сообщения и статистика',
    answer: 'Сообщения считаются автоматически. Для рейтинга нужно >50 за неделю. Если запись нужно убрать — админ чистит в “Controls”, счетчик обновится.',
    category: 'messages',
  },
  {
  ...
  },
  {
    ...
    answer: 'HUB: статус, категория, риск, трейдер + поиск. Lead: участники, статусы, виды (таблица/неделя). Tasks: статус, категория, участники. Score: список участников и детализация. Поиск в реальном времени.',
    category: 'interface',
  },
  {
